	...
	<div class="card">
		<div class="left">
			<div class="left-inner">
				<div class="logo-box">
					<img class="logo" src="/api/plugins/wizarrInvite/logo.png" alt="Wizarr Logo">
				</div>

				<div class="brand">
					<h1>Wizarr<br>Invitation</h1>
					<p>Use this invitation link to invite someone or restore your Plex access.</p>
				</div>

				<div class="footer-note">
					The displayed code is automatically checked when this page is loaded.
				</div>
			</div>
		</div>
		...
		<div class="right">
			<div id="app">
				<div class="loading">
					...
					<h2 class="title">Preparing the invitation</h2>
					<div class="subtitle">The plugin retrieves the active code or creates a new one if needed.</div>
...
.then(function(data){
	...
	app.innerHTML =
		...
		"<div class=\"help\">Use this link to invite someone or restore existing Plex access. The link above can be copied in one click.</div>";
